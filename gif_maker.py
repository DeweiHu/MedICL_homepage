# -*- coding: utf-8 -*-
"""
Created on Tue Dec 27 19:29:56 2022
...
image_root = "E:\\MedICL webpage\\imgs\\gif_maker\\"
save_root = "E:\\MedICL webpage\\imgs\\gif_maker\\"
name = "denoise"
gif_frames = []

prefix = "frame_"
numberlist = ["0","10","20","30","40","50"]

for i in range(len(numberlist)):
    im_name = prefix + numberlist[i] + ".png"
    im = imm.open(image_root + im_name)
    gif_frames.append(im)

fp_out = save_root + "{}.gif".format(name)
save_transparent_gif(gif_frames, 100, fp_out)

#%%
# save gif
imageio.mimsave(fp_out, gif_frames, duration=0.7)